document.addEventListener('DOMContentLoaded', () => {
  ...
  const mainSections = document.querySelectorAll('main > section:not(#cart-page)');
  ...
  // Добавление товаров — только кнопки внутри карточек товара
  ...
  // Открытие корзины по прямому переходу с #cart-page
